...
CREATE TABLE test_db.cdc_order2 (
	`order_id` VARCHAR(32) NOT NULL,
	`order_channel` VARCHAR(32) NULL,
	`order_time` VARCHAR(32) NULL,
	`pay_amount` DOUBLE  NULL,
	...
	DEFAULT CHARSET=utf8;
insert into test_db.cdc_order2 values ('t01', 'xx', '2023-12-01', 3, 3.4, '2023-07-11 12:35:12', 'jk1089463', 'tom', 'sz');
insert into test_db.cdc_order2 values ('t02', 'yy', '2023-12-02', 1.2, 2.4, '2023-07-11 13:36:05', 'jk1089463', 'tom', 'sz');
insert into test_db.cdc_order2 values ('t03', 'yy', '2023-12-02', 1.2, 2.4, '2023-07-11 13:36:05', 'jk1089463', 'tom', 'sz');